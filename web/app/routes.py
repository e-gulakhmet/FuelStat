...
# TODO: Починить обновление строки, которая была создана в браузере
#       (удаляется после изменения данных)
# TODO: Починить сортировку при получении данных из базы данных
#       (строка с меньшим пробегом стоит после строк с большим пробегом, при одной дате)
